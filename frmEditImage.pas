...
uses
  ...
  scControls, scGPControls, uGDIUnit, AARotate, AARotate_Fast;
...
begin
  if MessageDlg('The image has been changed. Do you really want to close this form?', mtConfirmation, mbYesNo, 0) = mrYes then
